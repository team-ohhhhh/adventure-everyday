...
# 🦍디자인 컨셉
<img src="./image/design-concept.jpeg" width="100%" height="100%"/>
...
3. 안테나 설치
    - 안테나 버튼 목록에 추가확인
    - 누르면 거기로 지도 이동하는 거 확인
    - 피드에 들어온거 확인
4. 안테나 뽑기
    - 피드에 없어진거 확인
5. 지도모드/탐험모드 기능
    - 탐험모드 달성 체크포인트 아이콘 다른거
6. 장소 검색
    - 눌러서 이동하기
...
3. 탐험 글 작성
    ...
    - 프로필에서 진행중인 탐험 진행률 확인 → 체크포인트 달성 이펙트→ 탐험 상세에서 지도 마커 바뀐거→ 지도탭 탐험모드 마커 바뀐것 확인 → (게시글 작성시 더이상 안나오는거 확인) → 프로필에서 진행중 탐험 진행률 바뀐거 확인
    
    3-2. 탐험 달성
    
    - 탐험 달성 이펙트 → 프로필에서 완료한 탐험에 추가된 것 확인 → 보물함에서 보물 생긴 것 보여주기  → 보물 눌러서 탐험 상세 페이지 → 후기 작성
4. 탐험 검색
5. 탐험 생성
