import style from "./AdventureBannerMore.module.css";
      ...
      {adventureItem && (
        <div
          ...
          style={{
            ...
            width: isAdTab ? "80%" : "100%",
            margin: isAdTab ? "1vh auto" : "0",
          }}
          onClick={() => {
...
export default AdventureBannerMore;
