...
function Reply({
  ...
  return (
        ...
        <div className={style.comment_content}>
          <div className={style.wouldYouDelete}>
            ...
            <div className={style.buttonHolder}>
              <button className={style.yesDelete} onClick={() => deleteReply()}>
                삭제
              </button>
              <button
            ...
            <div className={style.infoContainer}>
              ...
              {reply.userDetailRes.userId === USER.userId &&
                (wouldYouUpdate ? (
                  ...
                  whichReplyButton === reply.commentId ? (
                  <div
                    style={{
                      marginLeft: "auto",
                      marginRight: "3%",
                  ...
                  <RiMoreFill
                    ...
                    onClick={() => {
                      setReplyMoreButtonOpen(true);
                      setWhichReplyButton(reply.commentId);
                    }}
                  />
                ))}
            </div>
            ...
            <div className={style.text}>
              {wouldYouUpdate ? (
                <input
                  ...
                  onChange={onChange}
                  defaultValue={reply.commentContent}
                />
              ) : (
                <div>{reply.subCommentContent}</div>
              )}
            </div>
    ...
    //             </div>
    //           ) : replyMoreButtonOpen &&
    //             whichReplyButton === reply.subCommentId ? (
    //             <div
    //               style={{
    //                 marginLeft: "auto",
    //                 marginRight: "3%",
    ...
    //               onClick={() => {
    //                 setReplyMoreButtonOpen(true);
    //                 setWhichReplyButton(reply.subCommentId);
    //               }}
    //             />
    //           ))}
    //       </div>
    ...
    //           <input
    //             onChange={onChange}
    //             defaultValue={reply.subCommentContent}
    //           />
    //         ) : (
